package br.com.enginer.domain.system.usecase.template;
...
import br.com.enginer.domain.system.usecase.annotation.field.UIRadio;
...
import br.com.enginer.domain.system.usecase.annotation.field.behavior.autocomplete.UIAutoComplete;
...
import br.com.enginer.domain.system.usecase.annotation.instance.action.UISubmit;
...
import br.com.enginer.domain.system.usecase.schema.field.Field;
import br.com.enginer.domain.system.usecase.schema.field.behavior.Autocomplete;
import br.com.enginer.domain.system.usecase.schema.field.behavior.Base;
import br.com.enginer.domain.system.usecase.schema.field.behavior.Default;
import br.com.enginer.domain.system.usecase.schema.field.behavior.Pattern;
import br.com.enginer.domain.system.usecase.schema.field.behavior.Position;
import br.com.enginer.domain.system.usecase.schema.field.behavior.validation.Async;
import br.com.enginer.domain.system.usecase.schema.field.behavior.validation.Sync;
import br.com.enginer.domain.system.usecase.schema.field.behavior.validation.Validation;
import br.com.enginer.domain.system.usecase.schema.field.type.Area;
import br.com.enginer.domain.system.usecase.schema.field.type.Checkbox;
import br.com.enginer.domain.system.usecase.schema.field.type.Date;
import br.com.enginer.domain.system.usecase.schema.field.type.Decimal;
import br.com.enginer.domain.system.usecase.schema.field.type.Email;
...
import br.com.enginer.domain.system.usecase.schema.field.type.Radio;
import br.com.enginer.domain.system.usecase.schema.field.type.Select;
import br.com.enginer.domain.system.usecase.schema.field.type.Tag;
import br.com.enginer.domain.system.usecase.schema.field.type.Text;
import br.com.enginer.domain.system.usecase.schema.field.type.Time;
import br.com.enginer.domain.system.usecase.schema.instance.Action;
import br.com.enginer.domain.system.usecase.schema.instance.ActionObject;
import br.com.enginer.domain.system.usecase.schema.instance.ActionResponse;
import br.com.enginer.domain.system.usecase.schema.instance.ActionResponseError;
import br.com.enginer.domain.system.usecase.schema.instance.ActionResponseSuccess;
import br.com.enginer.domain.system.usecase.schema.instance.ActionTrigger;
import br.com.enginer.domain.system.usecase.schema.instance.Button;
...
import br.com.enginer.domain.system.usecase.schema.paginator.Paginator;
...
import br.com.enginer.domain.system.usecase.utils.ParamUtils;
	...
	private Paginator getPaginator(Domain<?> domain) throws Exception {
		...
		if (domain.getClass().isAnnotationPresent(UIPaginator.class)) {
			...
			if (uiListButtons.size() > 0) {
				...
				if (buttons != null) {
					buttons.forEach(button -> {
						br.com.enginer.domain.system.usecase.schema.field.Field fieldButton = new br.com.enginer.domain.system.usecase.schema.field.Field();
						fieldButton.setButton(button);
