package br.com.enginer.domain.system.usercase.template;
...
import br.com.enginer.domain.system.usercase.annotation.field.UIRadio;
...
import br.com.enginer.domain.system.usercase.annotation.field.behavior.autocomplete.UIAutoComplete;
...
import br.com.enginer.domain.system.usercase.annotation.instance.action.UISubmit;
...
import br.com.enginer.domain.system.usercase.schema.field.behavior.Default;
import br.com.enginer.domain.system.usercase.schema.field.behavior.Pattern;
import br.com.enginer.domain.system.usercase.schema.field.behavior.Position;
import br.com.enginer.domain.system.usercase.schema.field.behavior.validation.Async;
import br.com.enginer.domain.system.usercase.schema.field.behavior.validation.Sync;
import br.com.enginer.domain.system.usercase.schema.field.behavior.validation.Validation;
import br.com.enginer.domain.system.usercase.schema.field.type.Area;
import br.com.enginer.domain.system.usercase.schema.field.type.Checkbox;
import br.com.enginer.domain.system.usercase.schema.field.type.Date;
import br.com.enginer.domain.system.usercase.schema.field.type.Decimal;
import br.com.enginer.domain.system.usercase.schema.field.type.Email;
import br.com.enginer.domain.system.usercase.schema.field.type.File;
import br.com.enginer.domain.system.usercase.schema.field.type.Filter;
import br.com.enginer.domain.system.usercase.schema.field.type.Hidden;
import br.com.enginer.domain.system.usercase.schema.field.type.Id;
import br.com.enginer.domain.system.usercase.schema.field.type.Join;
import br.com.enginer.domain.system.usercase.schema.field.type.Number;
import br.com.enginer.domain.system.usercase.schema.field.type.Password;
import br.com.enginer.domain.system.usercase.schema.field.type.Radio;
import br.com.enginer.domain.system.usercase.schema.field.type.Select;
import br.com.enginer.domain.system.usercase.schema.field.type.Tag;
import br.com.enginer.domain.system.usercase.schema.field.type.Text;
import br.com.enginer.domain.system.usercase.schema.field.type.Time;
import br.com.enginer.domain.system.usercase.schema.instance.Action;
import br.com.enginer.domain.system.usercase.schema.instance.ActionObject;
import br.com.enginer.domain.system.usercase.schema.instance.ActionResponse;
import br.com.enginer.domain.system.usercase.schema.instance.ActionResponseError;
import br.com.enginer.domain.system.usercase.schema.instance.ActionResponseSuccess;
import br.com.enginer.domain.system.usercase.schema.instance.ActionTrigger;
import br.com.enginer.domain.system.usercase.schema.instance.Button;
import br.com.enginer.domain.system.usercase.schema.instance.Domain;
import br.com.enginer.domain.system.usercase.schema.instance.DomainId;
import br.com.enginer.domain.system.usercase.schema.paginator.Paginator;
...
import br.com.enginer.domain.system.usercase.schema.tab.Tab;
import br.com.enginer.domain.system.usercase.schema.validate.Validate;
import br.com.enginer.domain.system.usercase.schema.validate.conditional.Conditional;
import br.com.enginer.domain.system.usercase.schema.validate.custom.Custom;
import br.com.enginer.domain.system.usercase.schema.validate.dependency.Dependency;
import br.com.enginer.domain.system.usercase.schema.validate.global.Global;
import br.com.enginer.domain.system.usercase.utils.ParamUtils;
	...
	private Paginator getPaginator(Domain<?> domain) throws Exception {
		...
		if (domain.getClass().isAnnotationPresent(UIPaginator.class)) {
			...
			if (uiListButtons.size() > 0) {
				...
				if (buttons != null) {
					buttons.forEach(button -> {
						br.com.enginer.domain.system.usercase.schema.field.Field fieldButton = new br.com.enginer.domain.system.usercase.schema.field.Field();
						fieldButton.setButton(button);
